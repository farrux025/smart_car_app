...
class _ClusterizedPlacemarkCollectionExampleState
    extends State<ClusterizedPlacemarkCollectionExample> {
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: <
              ...
              ControlButton(
                  onPressed: () async {
                    ...
                    final largeMapObject = ClusterizedPlacemarkCollection(
                      ...
                      onTap:
                          (ClusterizedPlacemarkCollection self, Point point) =>
                              print('Tapped me at $point'),
                    );
              ...
              ControlButton(
                  onPressed: () async {
                    setState(() {
                      mapObjects
                          .removeWhere((el) => el.mapId == largeMapObjectId);
                    });
                  },
                  title: 'Remove')
            ])
...
class ControlButton extends StatelessWidget {
  ...
  ControlButton({super.key, required this.onPressed, required this.title});

  @override
  Widget build(BuildContext context) {
    return MaterialButton(
        onPressed: onPressed,
        color: AppColor.buttonRightColor,
        child: AppText(title, textColor: AppColor.white));
  }
}
